...
static const struct {
	...
	{ "TakeoverTimeout",      5,  offsetof(struct ctdb_tunable, takeover_timeout), false },
	...
	{ "DatabaseHashSize", 10000,  offsetof(struct ctdb_tunable, database_hash_size), false },
	...
	{ "RecoveryDropAllIPs",  60,  offsetof(struct ctdb_tunable, recovery_drop_all_ips), false },
